...
import { Home, ArrowRight, Sparkles, Target } from 'lucide-react';
...
export function PersonalizedStrategyCTA() {
  return (
    <section className="relative flex w-full flex-col overflow-hidden rounded-2xl border border-[#1E3D2F] bg-gradient-to-r from-black to-[#0F2A20] lg:flex-row">
      {/* Background Gradient */}
      <div
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-center px-8">
        ...
        <button className="group flex w-fit items-center gap-2 rounded-full bg-[#57B75C] px-8 h-11 text-sm font-semibold text-white transition-all hover:bg-[#4ca651] active:scale-95">
          Get Started
      ...
      <div className="relative max-h-[210px] overflow-hidden z-10 flex-1 w-full flex items-center justify-center">
