...
export function HoldingsWidget() {
  ...
  const formatCurrency = (value: number, currency?: string) => {
    return displayAmount(value, currency as CurrencyCode);
  };
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      >
                        {isPositive ? '+' : ''}
                        {formatCurrency(holding.todayChange || 0, holding.currency)}
                      </div>
                    </div>
                      ...
                      >
                        ...
                        <td className="py-4 px-4">
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <span className="text-sm font-medium text-foreground min-w-[45px] text-right">{allocation.toFixed(1)}%</span>
                          </div>
                        </td>
                      </tr>
                    );
