...
import { useUserStore, useIsAuthenticated, DEFAULT_SIGNIN_EMAIL } from '@/store/user.store';
        ...
        <div className="w-full flex-1 flex items-center justify-center py-16 max-w-[86em]">
          <div className="flex flex-1 flex-col lg:flex-row items-center lg:justify-around p-4 lg:p-0 gap-6">
            ...
            >
              ...
              <div className="self-stretch px-6 lg:px-12 flex flex-col justify-start items-start gap-6">
                ...
                <div className="pb-2 flex flex-col justify-start items-start w-full">
                  <h1 className="self-stretch text-white text-[25px] font-normal leading-[25px]">Login</h1>
                </div>
                ...
                <form id="signin-form" onSubmit={handleSubmit} className="self-stretch flex flex-col justify-start items-start gap-6">
                  ...
                  <div className="self-stretch flex flex-col justify-start items-start gap-1">
                    ...
                    <div className="self-stretch">
                      <input
                        ...
                        defaultValue={DEFAULT_SIGNIN_EMAIL}
                        required
                        autoComplete="email"
                  ...
                  <div className="self-stretch flex flex-col justify-start items-start gap-1">
                    ...
                    <div className="self-stretch relative">
                      ...
                      >
                        {showPassword ? <Eye className="w-6 h-6 text-[#B0B8BD]" /> : <EyeOff className="w-6 h-6 text-[#B0B8BD]" />}
                      </button>
                    </div>
                    <div className="inline-flex my-2 w-full">
                      <button type="button" className="text-sm text-[#8DA69B] font-light leading-5 hover:opacity-80 transition-opacity">
                        Forgot password?
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="w-full mt-2">
                    ...
                    >
                      <span className="text-base font-normal leading-6">{isLoading ? 'Signing in...' : 'Log In'}</span>
                    </Button>
                  </div>
                </form>
              </div>
              ...
              <div className="px-6 lg:px-12 flex flex-col justify-center items-start gap-3 w-full">
                ...
                >
                  ...
                  <span className="flex-1 text-white text-base font-light leading-6">Continue with passkey</span>
                </button>
            ...
            <div className="flex flex-1 items-center justify-center w-full max-w-[582px] lg:max-w-[530px]">
              <img src="/images/login-poster.png" alt="Sign in" className="w-full h-auto object-cover rounded-sm" />
            </div>
          </div>
        </div>
      </div>
