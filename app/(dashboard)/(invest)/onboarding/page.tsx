...
import { getAuth, setAuth, setExternalAccountId } from "@/lib/auth";
import Link from 'next/link';
import Image from 'next/image';
import { ChevronDown, Type } from "lucide-react";

type InvestmentChoice = "self-directed" | "ai-wealth";
...
export default function OnboardingPage() {
  ...
  const investmentChoice: InvestmentChoice =
    choice === "ai-wealth" ? "ai-wealth" : "self-directed";
